...
<hr/>
  <form action="product_update" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="Pbrand">Product Name :</label>
      <input type="text" class="form-control" id="pbrand" placeholder="Enter Product Name " name="Pbrand" value="${product.p_brand}">
    </div>
    <div class="form-group">
      <label for="Pdesc">Product Description :</label>
      <input type="text" class="form-control" id="p_description"  name="Pdesc" value="${product.p_desc}" >
    </div>
    <div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="s_id" class="form-control" name="pSuplier">
